...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO users (firstname, lastname, password, email, gender, phone, address, postalcode, rank) VALUES ('$firstname', '$lastname', '$password', '$email', '$gender', '$phone', '$address', '$postalcode', '$rank')";
