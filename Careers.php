...
<body background="Background.jpg">
    ...
    <div class="frame">
       ...
       min="1930-01-01" max="2005-01-01">
           ...
           <div class="inputfield">
            <label>gender</label>
            <input type="radio" id="ar" name="language" value="male">
<label for="ar">Male</label><br>

<input type="radio" id="en" name="language" value="female">
<label for="en">Female</label><br>
           </div>
           ...
           <div class="inputfield">
            ...
            <select id="Type of the job" name="Type of the job">
				<option value="Delivery guy">Delivery guy</option>
				<option value="Chief assistant">Chief assistant</option>
				<option value="waiter">waiter</option>
				<option value="Chef" disabled>Chef</option>
			</select>
           </div>
           <br>

           <div class="inputfield">
            <label for="avatar">ID card copy</label>
           ...
           <div class="inputfield">
            <label for="avatar">A personal photo of you</label>
          ...
          <div class="inputfield">
            ...
            <button class="btn">Send request</button></a>
          </div>
        </div>
    </div>
    <footer id="footer"><br>
